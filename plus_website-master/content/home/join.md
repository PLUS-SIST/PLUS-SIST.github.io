...
<!-- {{< figure library="true" src="flag.png" title="" lightbox="true" >}} -->
<!-- {{< icon name="flag" pack="fas" >}}  -->
:triangular_flag_on_post: We are recruiting **undergrad students** in SIST as **Research Assistant** for our projects.[Click for more information](ad/recruiting_bsc).
